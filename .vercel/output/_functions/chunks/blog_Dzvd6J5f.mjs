...
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, o as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent } from './astro/server_DgPtluSo.mjs';
import 'kleur/colors';
import * as devalue from 'devalue';
import { e as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, A as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './permalinks_BYwYTM8z.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_D1vF6Wrc.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CONVERTKIT_FORM_ID": "8052635", "PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpsaGN2amhtc2dudXZicXZqbnBjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDc1NjExMjUsImV4cCI6MjA2MzEzNzEyNX0._GZ5W_3TQWsd0aYo70NsAxdLwehSRAYA_NnGNW2v5zU", "PUBLIC_SUPABASE_URL": "https://jlhcvjhmsgnuvbqvjnpc.supabase.co", "SITE": "https://astrowind.vercel.app", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CLKYWX5i.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CqEcTmBy.mjs');
