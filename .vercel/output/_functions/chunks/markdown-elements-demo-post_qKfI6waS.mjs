import { a as createComponent, m as maybeRenderHead, b as renderTemplate, h as createVNode, F as Fragment, _ as __astro_tag_component__ } from './astro/server_DgPtluSo.mjs';
import 'kleur/colors';
import 'clsx';
import { S as SITE } from './permalinks_BYwYTM8z.mjs';
import { $ as $$YouTube, a as $$Tweet, b as $$Vimeo } from './post_BoAz5ZlA.mjs';
...
🚀 ${SITE?.name} </span>`;
}, "C:/Dev/jason_personal_website/src/components/Logo.astro", void 0);
...
const file = "C:/Dev/jason_personal_website/src/data/post/markdown-elements-demo-post.mdx";
...
Content.moduleId = "C:/Dev/jason_personal_website/src/data/post/markdown-elements-demo-post.mdx";
